...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_post'])) {
    ...
    if (empty($_POST['title'])) {
        ...
        try {
            // Update post
            $result = updateBlogPost($postId, $postData);
            ...
            if ($result) {
                ...
                if (!empty($_FILES['featured_image']['tmp_name'])) {
                    ...
                    if ($imagePath) {
                        ...
                        if ($post['featured_image'] && file_exists(ROOT_PATH . '/' . $post['featured_image'])) {
                            unlink(ROOT_PATH . '/' . $post['featured_image']);
                        }
                ...
                // Log activity
                logAdminActivity('update_post', 'مقاله به‌روزرسانی شد: ' . $postData['title']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_image'])) {
    ...
    updateBlogPost($postId, ['featured_image' => '']);
...
$pageTitle = "ویرایش مقاله - " . htmlspecialchars($post['title']);
require_once 'header.php';
?>

<div class="admin-content">
    <div class="admin-header">
        <h1><i class="fas fa-edit"></i> ویرایش مقاله</h1>
    ...
    <div class="dashboard-card">
        <div class="card-header">
            <h3>ویرایش مقاله: <?php echo htmlspecialchars($post['title']); ?></h3>
        </div>
        ...
        <form method="POST" action="edit_post.php?id=<?php echo $postId; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt" name="excerpt" 
                          ...
                          data-maxlength="300" 
                          placeholder="چکیده مقاله را وارد کنید"><?php echo htmlspecialchars($post['excerpt'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" 
                          ...
                          placeholder="محتوا را وارد کنید"><?php echo htmlspecialchars($post['content'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if ($post['featured_image']): ?>
                    <div style="margin-top: 16px; display: flex; align-items: center; gap: 12px;">
                        ...
                        <form method="POST" action="edit_post.php?id=<?php echo $postId; ?>" style="display: inline;">
                    ...
                    <div class="form-col full">
                        <div class="form-group">
                            ...
                            <textarea id="meta_description" name="meta_description" 
                                      class="form-control textarea-control" 
                                      data-maxlength="160" 
                                      placeholder="توضیحات سئو برای موتورهای جستجو"><?php echo htmlspecialchars($post['meta_description'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-col full">
                        <div class="form-group">
                            ...
                            <textarea id="meta_keywords" name="meta_keywords" 
                                      class="form-control textarea-control" 
                                      placeholder="کلمات کلیدی را با کاما جدا کنید"><?php echo htmlspecialchars($post['meta_keywords'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-col half">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="published_at" name="published_at" 
                                   class="form-control" 
                                   value="<?php echo date('Y-m-d\TH:i', strtotime($post['published_at'] ?? $post['created_at'])); ?>">
                        </div>
                    </div>
                    <div class="form-col half">
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="is_published" 
                                       value="1" <?php echo $post['is_published'] ? 'checked' : ''; ?>>
                                <span>منتشر شود</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="is_featured" 
                                       value="1" <?php echo $post['is_featured'] ? 'checked' : ''; ?>>
                                <span>ویژه</span>
                            </label>
                        </div>
                    </div>
